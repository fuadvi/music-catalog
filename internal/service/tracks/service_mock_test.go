...
import (
	...
	trackactivities "github.com/fuadvi/music-catalog/internal/models/trackactivities"
	spotify "github.com/fuadvi/music-catalog/internal/repository/spotify"
...
// GetBullSpotifyIDs mocks base method.
func (m *MocktrackActivitiesRepository) GetBullSpotifyIDs(ctx context.Context, userID uint, spotifyIDs []string) (map[string]trackactivities.TrackActivity, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetBullSpotifyIDs", ctx, userID, spotifyIDs)
	ret0, _ := ret[0].(map[string]trackactivities.TrackActivity)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetBullSpotifyIDs indicates an expected call of GetBullSpotifyIDs.
func (mr *MocktrackActivitiesRepositoryMockRecorder) GetBullSpotifyIDs(ctx, userID, spotifyIDs any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetBullSpotifyIDs", reflect.TypeOf((*MocktrackActivitiesRepository)(nil).GetBullSpotifyIDs), ctx, userID, spotifyIDs)
}
